...
- [1. 本节内容](#1-本节内容)
- [2. react v19 都有哪些重大更新？（待整理）](#2-react-v19-都有哪些重大更新待整理)
  - [2.1. 核心主题 — Actions（扩展的 Transition）与更深的表单/服务器集成](#21-核心主题--actions扩展的-transition与更深的表单服务器集成)
  - [2.2. 新的 Hook / API](#22-新的-hook--api)
  - [2.3. React DOM 客户端（表单/资源/脚本/样式相关的改进）](#23-react-dom-客户端表单资源脚本样式相关的改进)
  - [2.4. 服务端渲染 / Server Components / 静态生成](#24-服务端渲染--server-components--静态生成)
  - [2.5. 重要行为变化 / Strict Mode & 运行时注意事项](#25-重要行为变化--strict-mode--运行时注意事项)
  - [2.6. 被移除 / 弃用（Breaking changes & Removals — 要认真对待）](#26-被移除--弃用breaking-changes--removals--要认真对待)
  - [2.7. TypeScript 改动与 Codemod（实操建议）](#27-typescript-改动与-codemod实操建议)
  - [2.8. 升级建议（实践步骤）](#28-升级建议实践步骤)
  - [2.9. 常见迁移片段（示例）](#29-常见迁移片段示例)
  - [2.10. 总结](#210-总结)
- [3. 引用（官方原文）](#3-引用官方原文)
...
## 2. react v19 都有哪些重大更新？（待整理）

- 以下内容基于 React v19 官方 Release Notes + React 团队的博客/升级指南 的梳理与解读

### 2.1. 核心主题 — Actions（扩展的 Transition）与更深的表单/服务器集成
...
### 2.3. React DOM 客户端（表单/资源/脚本/样式相关的改进）
...
### 2.4. 服务端渲染 / Server Components / 静态生成
...
### 2.5. 重要行为变化 / Strict Mode & 运行时注意事项
...
### 2.6. 被移除 / 弃用（Breaking changes & Removals — 要认真对待）
...
### 2.7. TypeScript 改动与 Codemod（实操建议）
