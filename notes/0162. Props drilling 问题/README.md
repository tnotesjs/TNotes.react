...
- [1. 本节内容](#1-本节内容)
- [2. 什么是 Props Drilling？](#2-什么是-props-drilling)
  - [2.1. 基本示例](#21-基本示例)
  - [2.2. 更复杂的场景](#22-更复杂的场景)
- [3. Props Drilling 有什么问题？](#3-props-drilling-有什么问题)
  - [3.1. 问题 1：代码冗余](#31-问题-1代码冗余)
  - [3.2. 问题 2：难以维护](#32-问题-2难以维护)
  - [3.3. 问题 3：组件耦合](#33-问题-3组件耦合)
  - [3.4. 问题 4：重构困难](#34-问题-4重构困难)
- [4. 如何解决 Props Drilling？](#4-如何解决-props-drilling)
  - [4.1. 方案 1：使用 Context API](#41-方案-1使用-context-api)
  - [4.2. 方案 2：组件组合](#42-方案-2组件组合)
  - [4.3. 方案 3：使用状态管理库](#43-方案-3使用状态管理库)
  - [4.4. 方案 4：自定义 Hooks](#44-方案-4自定义-hooks)
  - [4.5. 方案 5：Render Props](#45-方案-5render-props)
  - [4.6. 综合示例：解决复杂场景](#46-综合示例解决复杂场景)
- [5. 不同解决方案如何选择？](#5-不同解决方案如何选择)
  - [5.1. 选择决策表](#51-选择决策表)
  - [5.2. 方案对比](#52-方案对比)
  - [5.3. 实践建议](#53-实践建议)
- [6. 引用](#6-引用)
...
## 4. 如何解决 Props Drilling？

### 4.1. 方案 1：使用 Context API
