...
- [2. 评价](#2-评价)
- [3. 提示词](#3-提示词)
- [4. 入口文件的作用是什么？](#4-入口文件的作用是什么)
- [5. React 18 和 React 19 的入口文件有什么区别？](#5-react-18-和-react-19-的入口文件有什么区别)
- [6. 入口文件中都做了哪些事情？](#6-入口文件中都做了哪些事情)
- [7. StrictMode 有什么作用？](#7-strictmode-有什么作用)
- [8. 如何在入口文件中添加全局配置？](#8-如何在入口文件中添加全局配置)
- [9. 入口文件的常见错误有哪些？](#9-入口文件的常见错误有哪些)
- [10. 总结](#10-总结)
- [11. 引用](#11-引用)
...
## 5. React 18 和 React 19 的入口文件有什么区别？
