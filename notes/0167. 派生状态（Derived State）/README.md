...
- [2. 什么是派生状态？](#2-什么是派生状态)
  - [2.1. 基本概念](#21-基本概念)
  - [2.2. 派生状态的特征](#22-派生状态的特征)
- [3. � 为什么避免存储派生状态？](#3--为什么避免存储派生状态)
  - [3.1. 问题 1：数据不一致](#31-问题-1数据不一致)
  - [3.2. 问题 2：代码复杂度增加](#32-问题-2代码复杂度增加)
  - [3.3. 问题 3：容易出错](#33-问题-3容易出错)
- [4. 如何正确使用派生状态？](#4-如何正确使用派生状态)
  - [4.1. 方法 1：直接计算](#41-方法-1直接计算)
  - [4.2. 方法 2：使用函数封装](#42-方法-2使用函数封装)
  - [4.3. 方法 3：避免从 props 派生状态](#43-方法-3避免从-props-派生状态)
- [5. 什么时候需要缓存派生值？](#5-什么时候需要缓存派生值)
  - [5.1. 使用 useMemo 的时机](#51-使用-usememo-的时机)
  - [5.2. 性能对比](#52-性能对比)
  - [5.3. useMemo 的正确使用](#53-usememo-的正确使用)
- [6. 派生状态的常见陷阱？](#6-派生状态的常见陷阱)
  - [6.1. 陷阱 1：过度使用 useMemo](#61-陷阱-1过度使用-usememo)
  - [6.2. 陷阱 2：忘记依赖项](#62-陷阱-2忘记依赖项)
  - [6.3. 陷阱 3：在循环中计算](#63-陷阱-3在循环中计算)
  - [6.4. 陷阱 4：从 props 派生复杂状态](#64-陷阱-4从-props-派生复杂状态)
  - [6.5. 陷阱 5：派生状态依赖其他派生状态](#65-陷阱-5派生状态依赖其他派生状态)
- [7. 引用](#7-引用)
