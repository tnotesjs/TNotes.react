...
- [1. 本节内容](#1-本节内容)
- [2. 声明式编程是什么？](#2-声明式编程是什么)
- [3. 命令式编程是什么？](#3-命令式编程是什么)
- [4. 声明式 vs 命令式对比](#4-声明式-vs-命令式对比)
  - [4.1. 核心区别对比表](#41-核心区别对比表)
  - [4.2. 不同编程范式的例子](#42-不同编程范式的例子)
  - [4.3. 生活化示例](#43-生活化示例)
  - [4.4. 代码示例对比](#44-代码示例对比)
- [5. React 为什么选择声明式？](#5-react-为什么选择声明式)
- [6. 总结](#6-总结)
- [7. 引用](#7-引用)
