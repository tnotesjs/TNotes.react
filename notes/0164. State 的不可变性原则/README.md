...
- [1. 本节内容](#1-本节内容)
- [2. 什么是 State 的不可变性？](#2-什么是-state-的不可变性)
  - [2.1. 基本概念](#21-基本概念)
  - [2.2. 引用相等性检查](#22-引用相等性检查)
  - [2.3. 不可变性的要求](#23-不可变性的要求)
- [3. 为什么需要遵守不可变性？](#3-为什么需要遵守不可变性)
  - [3.1. 原因 1：确保重新渲染](#31-原因-1确保重新渲染)
  - [3.2. 原因 2：性能优化生效](#32-原因-2性能优化生效)
  - [3.3. 原因 3：避免意外的副作用](#33-原因-3避免意外的副作用)
  - [3.4. 原因 4：时间旅行调试](#34-原因-4时间旅行调试)
- [4. 如何正确更新不同类型的 State？](#4-如何正确更新不同类型的-state)
  - [4.1. 更新对象](#41-更新对象)
  - [4.2. 更新嵌套对象](#42-更新嵌套对象)
  - [4.3. 更新数组](#43-更新数组)
  - [4.4. 更新数组中的对象](#44-更新数组中的对象)
- [5. 不可变更新的常见错误？](#5-不可变更新的常见错误)
  - [5.1. 错误 1：使用变异方法](#51-错误-1使用变异方法)
  - [5.2. 错误 2：部分展开](#52-错误-2部分展开)
  - [5.3. 错误 3：共享引用](#53-错误-3共享引用)
  - [5.4. 错误 4：异步更新中的闭包问题](#54-错误-4异步更新中的闭包问题)
- [6. � 如何简化不可变更新？](#6--如何简化不可变更新)
  - [6.1. 使用 Immer](#61-使用-immer)
  - [6.2. 对比传统方式和 Immer](#62-对比传统方式和-immer)
  - [6.3. 自定义 Hook 封装](#63-自定义-hook-封装)
  - [6.4. 使用工具函数](#64-使用工具函数)
- [7. 引用](#7-引用)
