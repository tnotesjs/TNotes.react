...
- [1. 本节内容](#1-本节内容)
- [2. 组件的挂载流程是什么？](#2-组件的挂载流程是什么)
- [3. 组件的更新流程是什么？](#3-组件的更新流程是什么)
- [4. 组件的卸载流程是什么？](#4-组件的卸载流程是什么)
- [5. 类组件和函数组件的流程有何区别？](#5-类组件和函数组件的流程有何区别)
- [6. 如何追踪组件的生命周期？](#6-如何追踪组件的生命周期)
- [7. 生命周期流程中常见的错误有哪些？](#7-生命周期流程中常见的错误有哪些)
- [8. 类组件 vs 函数组件流程对比](#8-类组件-vs-函数组件流程对比)
- [9. 引用](#9-引用)
