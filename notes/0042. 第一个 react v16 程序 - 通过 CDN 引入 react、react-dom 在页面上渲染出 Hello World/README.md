...
- [6. 🤔 `React.createElement` 跟 `document.createElement` 是一样的吗？](#6--reactcreateelement-跟-documentcreateelement-是一样的吗)
- [7. 🤔 `react` 核心库和 `react-dom` 库之间的关系是？](#7--react-核心库和-react-dom-库之间的关系是)
- [8. 🤔 为什么一旦使用了 `JSX` 语法，就必须要引入 `react` 核心库？](#8--为什么一旦使用了-jsx-语法就必须要引入-react-核心库)
- [9. 🤔 通过脚手架（比如 vite、umi、create-react-app）来搭建工程 vs. 通过（.html）页面的方式来直接引入 react 相关的库](#9--通过脚手架比如-viteumicreate-react-app来搭建工程-vs-通过html页面的方式来直接引入-react-相关的库)
- [10. 🔗 参考资料](#10--参考资料)
...
## 6. 🤔 `React.createElement` 跟 `document.createElement` 是一样的吗？
...
## 7. 🤔 `react` 核心库和 `react-dom` 库之间的关系是？
...
## 8. 🤔 为什么一旦使用了 `JSX` 语法，就必须要引入 `react` 核心库？
...
## 9. 🤔 通过脚手架（比如 vite、umi、create-react-app）来搭建工程 vs. 通过（.html）页面的方式来直接引入 react 相关的库
