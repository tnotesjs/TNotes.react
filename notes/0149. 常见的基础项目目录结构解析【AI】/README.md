...
- [2. 评价](#2-评价)
- [3. 提示词](#3-提示词)
- [4. 使用 Vite 创建的 React 项目目录结构是怎样的？](#4-使用-vite-创建的-react-项目目录结构是怎样的)
- [5. 各个目录和文件的作用是什么？](#5-各个目录和文件的作用是什么)
- [6. 如何组织大型项目的目录结构？](#6-如何组织大型项目的目录结构)
- [7. 常见的目录命名规范有哪些？](#7-常见的目录命名规范有哪些)
- [8. 如何处理静态资源文件？](#8-如何处理静态资源文件)
- [9. 总结](#9-总结)
- [10. 引用](#10-引用)
...
我们在实际开发 React 项目时，往往不会直接通过一个简单的 `.html` 文件去创建一个项目，而是借助一些构建工具来搭建一个真实的工程文件夹，这个文件夹的具体内容涉及到的知识点不仅限于 React。

这篇笔记记录了 AI 的回复，目的是让你先大概知道实际的项目结构大概是长什么样的，知道真实开发往往不是一个 `.html` 去实现的。
...
## 4. 使用 Vite 创建的 React 项目目录结构是怎样的？
