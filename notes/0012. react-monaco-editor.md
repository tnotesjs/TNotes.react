---
id: b20049dd-ef17-4d74-9631-0ba3da8299e8
---
...
- [Monaco](https://github.com/Tdahuyou/en-words/blob/main/Monaco.md)
  ...
  - 英 `/ ˈmɒnəkəʊ /`
  - 美 `/ ˈmɑːnəkoʊ /`
  - ![](../assets/0012-2024-09-25-10-23-31.png)
...
![](../assets/0012-2024-09-25-09-31-27.png)
...
- 输出日志：
  - ![](../assets/0012-2024-09-25-09-44-15.png)
...
![](../assets/0012-2024-09-25-09-49-00.png)
...
![](../assets/0012-2024-09-25-10-11-41.png)
...
- 最终效果：
  - ![](../assets/0012-2024-09-25-10-17-30.png)
- 有关 editor 实例身上的 API：
  - 🔍 Monaco Editor API
...
- 可以在 https://vinci.matatastudio.com/ 中查看参考的代码预览效果示例：
  - ![](../assets/0012-2024-09-25-11-31-27.png)
- 需要注意的一些细节：
  - 1️⃣ 展开和收起需要有动画过渡效果
  - 2️⃣ 预览区域是只读的
...
- 最终效果：
  - ![](../assets/0012-2025-02-13-14-46-37.png)
...
- 问题：monaco-react 中依赖的在线 CDN 资源下载缓慢，导致程序打开后首次加载时间过长，甚至打开后报错。
  ...
  - 现象：页面上看到的效果如下图所示，会一直提示在 loading 中。
    - ![](../assets/0012-2024-10-08-10-36-19.png)
  - 原因分析：依赖于 CDN 上的 monaco-editor 相关的核心模块下载失败。
    - ![](../assets/0012-2024-10-08-10-38-02.png)
...
- ![](../assets/0012-2024-10-08-10-44-04.png)
...
- 使用这种做法需要注意 Web Worker 资源的跨域加载问题。
  ...
  - ![](../assets/0012-2025-02-13-14-02-14.png)
  - 补充：
...
- 手动下载资源的具体步骤：
  ...
  - 测试是否配置成功：
    ...
    - ![](../assets/0012-2024-10-28-16-06-48.png)
...
- ![](../assets/0012-2024-10-29-22-44-11.png)
...
- 如果是要在 scratch-gui 中加，还需要在默认的 webpack.config.js 中加上这部分配置。
  - ![](../assets/0012-2024-10-29-22-47-44.png)
...
- 如果发现 编辑器的样式异常，这有可能是因为有个核心的样式模块解析出错了。
  - 手动处理方式：
    ...
    - 将其丢到 static 中，和站标 favicon.ico 目录相同。
      - ![](../assets/0012-2024-10-29-22-49-00.png)
    - 然后在页面模板 `scratch-gui\src\playground\index.ejs` 中加上这个 css 的引用。
      - ![](../assets/0012-2024-10-29-22-49-06.png)
  - 自动处理方式：
