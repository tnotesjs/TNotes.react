...
- [1. 本节内容](#1-本节内容)
- [2. eslint 是什么？](#2-eslint-是什么)
- [3. eslint 有啥用？](#3-eslint-有啥用)
- [4. 感觉 eslint 很烦，可以不用吗？](#4-感觉-eslint-很烦可以不用吗)
- [5. 学习阶段要用 eslint 吗？](#5-学习阶段要用-eslint-吗)
- [6. 如何在 VSCode 中安装 ESLint 插件？](#6-如何在-vscode-中安装-eslint-插件)
- [7. 如何完成 eslint 配置的初始化？](#7-如何完成-eslint-配置的初始化)
- [8. eslint 具体都有哪些配置？具体作用是什么？](#8-eslint-具体都有哪些配置具体作用是什么)
- [9. demos.1 - 约束只能使用单引号，不能使用双引号](#9-demos1---约束只能使用单引号不能使用双引号)
- [10. 使用 eslint 还有哪些需要注意的点？](#10-使用-eslint-还有哪些需要注意的点)
  - [10.1. 性能影响](#101-性能影响)
  - [10.2. 与其他插件的兼容性](#102-与其他插件的兼容性)
- [11. 引用](#11-引用)
...
## 8. eslint 具体都有哪些配置？具体作用是什么？

- [eslint docs][1] -> 查阅 eslint 官方文档。

## 9. demos.1 - 约束只能使用单引号，不能使用双引号
