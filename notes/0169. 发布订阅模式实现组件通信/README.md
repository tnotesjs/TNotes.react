...
- [1. 本节内容](#1-本节内容)
- [2. 什么是发布订阅模式？](#2-什么是发布订阅模式)
  - [2.1. 基本概念](#21-基本概念)
  - [2.2. 发布订阅 vs 观察者模式](#22-发布订阅-vs-观察者模式)
  - [2.3. 核心特点](#23-核心特点)
- [3. � 如何实现事件总线？](#3--如何实现事件总线)
  - [3.1. 基础实现](#31-基础实现)
  - [3.2. 增强实现](#32-增强实现)
  - [3.3. TypeScript 实现](#33-typescript-实现)
- [4. 如何在 React 中使用事件总线？](#4-如何在-react-中使用事件总线)
  - [4.1. 基本使用](#41-基本使用)
  - [4.2. 封装自定义 Hook](#42-封装自定义-hook)
  - [4.3. 实战示例：全局通知系统](#43-实战示例全局通知系统)
- [5. 发布订阅模式的应用场景？](#5-发布订阅模式的应用场景)
  - [5.1. 场景 1：跨组件通知](#51-场景-1跨组件通知)
  - [5.2. 场景 2：全局状态同步](#52-场景-2全局状态同步)
  - [5.3. 场景 3：解耦业务逻辑](#53-场景-3解耦业务逻辑)
  - [5.4. 场景 4：实时通信](#54-场景-4实时通信)
  - [5.5. 场景 5：插件系统](#55-场景-5插件系统)
- [6. 发布订阅模式的注意事项？](#6-发布订阅模式的注意事项)
  - [6.1. 注意事项 1：内存泄漏](#61-注意事项-1内存泄漏)
  - [6.2. 注意事项 2：回调依赖问题](#62-注意事项-2回调依赖问题)
  - [6.3. 注意事项 3：事件命名冲突](#63-注意事项-3事件命名冲突)
  - [6.4. 注意事项 4：调试困难](#64-注意事项-4调试困难)
  - [6.5. 注意事项 5：避免循环触发](#65-注意事项-5避免循环触发)
- [7. 发布订阅 vs 其他通信方式](#7-发布订阅-vs-其他通信方式)
  - [7.1. 对比表格](#71-对比表格)
  - [7.2. 各方案对比示例](#72-各方案对比示例)
- [8. 引用](#8-引用)
