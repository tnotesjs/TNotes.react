...
- [2. 基本用法对比](#2-基本用法对比)
  - [2.1. 简单计数器](#21-简单计数器)
  - [2.2. 表单状态管理](#22-表单状态管理)
  - [2.3. 对比总结表格](#23-对比总结表格)
- [3. 什么时候用 useState？](#3-什么时候用-usestate)
  - [3.1. 场景 1：简单的独立状态](#31-场景-1简单的独立状态)
  - [3.2. 场景 2：不相关的多个状态](#32-场景-2不相关的多个状态)
  - [3.3. 场景 3：简单的数组或对象](#33-场景-3简单的数组或对象)
  - [3.4. 场景 4：异步数据加载](#34-场景-4异步数据加载)
- [4. 什么时候用 useReducer？](#4-什么时候用-usereducer)
  - [4.1. 场景 1：复杂的状态逻辑](#41-场景-1复杂的状态逻辑)
  - [4.2. 场景 2：状态转换逻辑复杂](#42-场景-2状态转换逻辑复杂)
  - [4.3. 场景 3：需要优化性能](#43-场景-3需要优化性能)
  - [4.4. 场景 4：状态逻辑需要测试](#44-场景-4状态逻辑需要测试)
- [5. 如何选择使用哪个？](#5-如何选择使用哪个)
  - [5.1. 决策树](#51-决策树)
  - [5.2. 实际例子对比](#52-实际例子对比)
  - [5.3. 从 useState 迁移到 useReducer](#53-从-usestate-迁移到-usereducer)
- [6. useReducer 的优势是什么？](#6-usereducer-的优势是什么)
  - [6.1. 优势 1：逻辑集中](#61-优势-1逻辑集中)
  - [6.2. 优势 2：引用稳定](#62-优势-2引用稳定)
  - [6.3. 优势 3：易于测试](#63-优势-3易于测试)
  - [6.4. 优势 4：可预测性](#64-优势-4可预测性)
- [7. 引用](#7-引用)
