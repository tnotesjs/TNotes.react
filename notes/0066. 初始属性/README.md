...
- [1. 本节内容](#1-本节内容)
- [2. Props 是什么？](#2-props-是什么)
- [3. Props 是只读的吗？](#3-props-是只读的吗)
- [4. Props 都可以传哪些值呢？](#4-props-都可以传哪些值呢)
- [5. 函数组件和类组件分别如何接收父组件传递过来的属性呢？](#5-函数组件和类组件分别如何接收父组件传递过来的属性呢)
- [6. 组件属性都有哪些比较重要的“技巧”？](#6-组件属性都有哪些比较重要的技巧)
