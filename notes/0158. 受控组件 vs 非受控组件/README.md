...
- [2. 基本概念对比](#2-基本概念对比)
  - [2.1. 核心区别](#21-核心区别)
  - [2.2. 受控组件定义](#22-受控组件定义)
  - [2.3. 非受控组件定义](#23-非受控组件定义)
- [3. 实现方式对比](#3-实现方式对比)
  - [3.1. 文本输入](#31-文本输入)
  - [3.2. 复选框](#32-复选框)
  - [3.3. 下拉选择](#33-下拉选择)
...
- [4. 使用场景对比](#4-使用场景对比)
  - [4.1. 场景选择表](#41-场景选择表)
  - [4.2. 实时验证场景](#42-实时验证场景)
  - [4.3. 输入格式化场景](#43-输入格式化场景)
  - [4.4. 简单表单场景](#44-简单表单场景)
  - [4.5. 第三方库集成场景](#45-第三方库集成场景)
  - [4.6. 条件性禁用场景](#46-条件性禁用场景)
- [5. 性能对比](#5-性能对比)
  - [5.1. 渲染性能对比](#51-渲染性能对比)
  - [5.2. 受控组件性能问题](#52-受控组件性能问题)
  - [5.3. 使用 useCallback 优化](#53-使用-usecallback-优化)
- [6. 如何选择受控还是非受控？](#6-如何选择受控还是非受控)
  - [6.1. 决策流程图](#61-决策流程图)
  - [6.2. 选择建议](#62-选择建议)
  - [6.3. 混合使用策略](#63-混合使用策略)
- [7. 受控组件的常见问题如何解决？](#7-受控组件的常见问题如何解决)
  - [7.1. 问题 1：输入中文时的重复字符](#71-问题-1输入中文时的重复字符)
  - [7.2. 问题 2：光标位置异常](#72-问题-2光标位置异常)
  - [7.3. 问题 3：频繁渲染导致性能问题](#73-问题-3频繁渲染导致性能问题)
  - [7.4. 问题 4：Warning - value 从 undefined 变为 controlled](#74-问题-4warning---value-从-undefined-变为-controlled)
- [8. 如何在受控和非受控之间转换？](#8-如何在受控和非受控之间转换)
  - [8.1. 从非受控转为受控](#81-从非受控转为受控)
  - [8.2. 从非受控读取值并转为受控](#82-从非受控读取值并转为受控)
  - [8.3. 使用 key 强制重置组件](#83-使用-key-强制重置组件)
  - [8.4. 封装混合模式组件](#84-封装混合模式组件)
- [9. 引用](#9-引用)
...
### 7.4. 问题 4：Warning - value 从 undefined 变为 controlled
