...
- [1. 本节内容](#1-本节内容)
- [2. 什么是自定义 Hooks？](#2-什么是自定义-hooks)
- [3. 如何创建自定义 Hooks？](#3-如何创建自定义-hooks)
- [4. 常见的自定义 Hooks 有哪些？](#4-常见的自定义-hooks-有哪些)
  - [4.1. useLocalStorage](#41-uselocalstorage)
  - [4.2. useWindowSize](#42-usewindowsize)
  - [4.3. useToggle](#43-usetoggle)
  - [4.4. usePrevious](#44-useprevious)
  - [4.5. useInterval](#45-useinterval)
- [5. 自定义 Hooks 的最佳实践是什么？](#5-自定义-hooks-的最佳实践是什么)
- [6. 自定义 Hooks 的常见错误有哪些？](#6-自定义-hooks-的常见错误有哪些)
- [7. 如何测试自定义 Hooks？](#7-如何测试自定义-hooks)
- [8. 自定义 Hooks vs HOC vs Render Props](#8-自定义-hooks-vs-hoc-vs-render-props)
- [9. 引用](#9-引用)
...
## 8. 自定义 Hooks vs HOC vs Render Props
