...
- [1. 本节内容](#1-本节内容)
- [2. 评价](#2-评价)
- [3. React 简介](#3-react-简介)
  - [3.1. React 是什么？](#31-react-是什么)
  - [3.2. React 官网链接是？](#32-react-官网链接是)
  - [3.3. React 的 GitHub 仓库链接是？](#33-react-的-github-仓库链接是)
  - [3.4. React 都有哪些特点？](#34-react-都有哪些特点)
- [4. React 的轻量表现在哪些方面？](#4-react-的轻量表现在哪些方面)
  - [4.1. development 版本](#41-development-版本)
  - [4.2. production 版本](#42-production-版本)
    - [为什么这个 `react` 核心包这么小？](#为什么这个-react-核心包这么小)
    - [真正干“脏活累活”的大头在哪里？](#真正干脏活累活的大头在哪里)
    - [为什么要这么拆分？（为了跨平台）](#为什么要这么拆分为了跨平台)
  - [4.3. 如何验证](#43-如何验证)
- [5. React 的原生表现在哪些方面？](#5-react-的原生表现在哪些方面)
  - [5.1. 原生 JS 书写](#51-原生-js-书写)
  - [5.2. 不依赖宿主环境](#52-不依赖宿主环境)
- [6. React 的灵活表现在哪些方面？](#6-react-的灵活表现在哪些方面)
- [7. 单向数据流是什么？](#7-单向数据流是什么)
- [8. 为什么官方特别强调 React 是一个库，而非框架呢？](#8-为什么官方特别强调-react-是一个库而非框架呢)
  - [8.1. 库 vs. 框架（React vs. Vue）](#81-库-vs-框架react-vs-vue)
  - [8.2. “库”和“框架”的定义](#82-库和框架的定义)
  - [8.3. 一个著名的软件工程核心概念：控制反转（Inversion of Control，简称 IoC）](#83-一个著名的软件工程核心概念控制反转inversion-of-control简称-ioc)
  - [8.4. 其它角度：从“侵入性”角度来对比](#84-其它角度从侵入性角度来对比)
  - [8.5. 小结](#85-小结)
    - [react](#react)
    - [vue](#vue)
- [9. 引用](#9-引用)
...
## 8. 为什么官方特别强调 React 是一个库，而非框架呢？

### 8.1. 库 vs. 框架（React vs. Vue）
...
### 8.3. 一个著名的软件工程核心概念：控制反转（Inversion of Control，简称 IoC）
