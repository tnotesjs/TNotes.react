...
- [3. React 的轻量表现在哪些方面？](#3-react-的轻量表现在哪些方面)
  ...
  - [3.3. 如何验证](#33-如何验证)
- [4. React 的原生表现在哪些方面？](#4-react-的原生表现在哪些方面)
  - [4.1. 原生 JS 书写](#41-原生-js-书写)
  - [4.2. 不依赖宿主环境](#42-不依赖宿主环境)
- [5. React 的灵活表现在哪些方面？](#5-react-的灵活表现在哪些方面)
- [6. 单向数据流是什么？](#6-单向数据流是什么)
- [7. 为什么官方特别强调 React 是一个库，而非框架呢？](#7-为什么官方特别强调-react-是一个库而非框架呢)
