---
id: ae897395-c790-4403-9230-c115e807e4af
---
...
- 最终渲染结果：
  - 中文：
    - ![](../assets/0038-2025-01-02-15-45-37.png)
  - 英文：
    - ![](../assets/0038-2025-01-02-15-45-44.png)
...
- FormattedMessage、FormattedNumber - 用于格式化消息数据，让数据展示格式具备国际化需求。
  ...
  - FormattedMessage 的 values
    ...
    - 最后一部分 `::yyyy年M月d日 hh:mm:ss` 用于指定日期的格式。
      ...
      - ![](../assets/0038-2025-01-23-16-42-46.png)
...
- ![](../assets/0038-2025-01-03-10-56-42.png)
- ![](../assets/0038-2025-01-03-10-56-52.png)
