...
- [2. 什么是批处理？](#2-什么是批处理)
  - [2.1. 基本概念](#21-基本概念)
  - [2.2. 批处理的好处](#22-批处理的好处)
  - [2.3. 批处理的执行时机](#23-批处理的执行时机)
- [3. React 18 的自动批处理有什么变化？](#3-react-18-的自动批处理有什么变化)
  - [3.1. React 17 vs React 18](#31-react-17-vs-react-18)
  - [3.2. 各种场景下的批处理](#32-各种场景下的批处理)
  - [3.3. React 18 迁移注意事项](#33-react-18-迁移注意事项)
- [4. 如何退出批处理？](#4-如何退出批处理)
  - [4.1. 使用 flushSync](#41-使用-flushsync)
  - [4.2. flushSync 的应用场景](#42-flushsync-的应用场景)
  - [4.3. flushSync 的注意事项](#43-flushsync-的注意事项)
- [5. 批处理如何影响性能？](#5-批处理如何影响性能)
  - [5.1. 性能对比](#51-性能对比)
  - [5.2. 减少不必要的渲染](#52-减少不必要的渲染)
  - [5.3. 性能监控](#53-性能监控)
- [6. 批处理的常见问题？](#6-批处理的常见问题)
  - [6.1. 问题 1：状态更新后立即读取](#61-问题-1状态更新后立即读取)
  - [6.2. 问题 2：批处理与 useEffect](#62-问题-2批处理与-useeffect)
  - [6.3. 问题 3：条件更新](#63-问题-3条件更新)
  - [6.4. 问题 4：父子组件更新顺序](#64-问题-4父子组件更新顺序)
- [7. 引用](#7-引用)
