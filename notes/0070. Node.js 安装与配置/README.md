...
- [1. 本节内容](#1-本节内容)
- [2. 学习 React 为何要安装 Node.js 呢？](#2-学习-react-为何要安装-nodejs-呢)
- [3. 如何安装 Node.js？](#3-如何安装-nodejs)
- [4. 如何验证 Node.js 是否已经安装成功？](#4-如何验证-nodejs-是否已经安装成功)
- [5. 安装好 Node.js 之后，有什么需要配置的吗？](#5-安装好-nodejs-之后有什么需要配置的吗)
  - [5.1. 主要配置内容](#51-主要配置内容)
  - [5.2. 对初学者的建议](#52-对初学者的建议)
- [6. 引用](#6-引用)
