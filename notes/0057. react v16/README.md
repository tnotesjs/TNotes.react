...
- [1. 本节内容](#1-本节内容)
- [2. react v16 都有哪些重大更新？（待整理）](#2-react-v16-都有哪些重大更新待整理)
  - [2.1. 全新 Fiber Reconciler（核心重构）](#21-全新-fiber-reconciler核心重构)
  - [2.2. 错误边界（Error Boundaries）](#22-错误边界error-boundaries)
  - [2.3. 支持返回多个元素（Fragments 的前身）](#23-支持返回多个元素fragments-的前身)
  - [2.4. Portals（传送门）](#24-portals传送门)
  - [2.5. 更好的服务端渲染（SSR）支持](#25-更好的服务端渲染ssr支持)
  - [2.6. 更友好的错误和警告信息](#26-更友好的错误和警告信息)
  - [2.7. 许可证变更（临时争议）](#27-许可证变更临时争议)
  - [2.8. Breaking Changes（破坏性变更）](#28-breaking-changes破坏性变更)
  - [2.9. 其他改进](#29-其他改进)
- [3. 引用](#3-引用)
